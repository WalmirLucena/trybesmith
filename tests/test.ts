...
describe.skip("1 - Crie um endpoint para o cadastro de pessoas usuárias", () => {
...
describe.skip("2 - Crie um endpoint para o login de pessoas usuárias", () => {
...
describe.skip("4 - Crie um endpoint para a listagem de produtos", () => {
  let token: string;
